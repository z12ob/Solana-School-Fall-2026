...
## Solana SVM Blueprint

[View the PDF](../../assets/session-01/solana-svm-blueprint.pdf)

A 12-page visual reference covering accounts, transactions, parallel scheduling, PDAs, CPI, compute limits, clusters, and the Anchor workflow.
...
Both artifacts were generated from the final Session 1 notes and verified against public Solana documentation. They do not reproduce official course slides or recordings and are not official Solana Foundation material.
